    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="product-card">
          ...
          <div class="product-thumb">
            <a href="product.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products/1.jpg" alt=""></a>
          </div>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="product-card">
          ...
          <div class="product-thumb">
            <a href="product.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products/5.jpg" alt=""></a>
          </div>
          <div class="product-details">
            <h4>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="product-card">
          ...
          <div class="product-thumb">
            <a href="product.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products/6.jpg" alt=""></a>
          </div>
          <div class="product-details">
            <h4>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="product-card">
          ...
          <div class="product-thumb">
            <a href="product.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products/7.jpg" alt=""></a>
          </div>
          <div class="product-details">
            <h4>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-3">
        <div class="product-card">
          ...
          <div class="product-thumb">
            <a href="product.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products/8.jpg" alt=""></a>
          </div>
          <div class="product-details">
            <h4>
